...
static public class NGUIEditorTools
{
    ...
    static public string GetSaveableTexturePath(UIAtlas atlas)
    {
        ...
        {
            path = AssetDatabase.GetAssetPath(atlas.texture);
        ...
        path = AssetDatabase.GetAssetPath(atlas);
    ...
    static public MonoScript GetClassID(System.Type type)
    {
        ...
        SerializedObject ob = new SerializedObject(component);
        MonoScript script = ob.FindProperty("m_Script").objectReferenceValue as MonoScript;
        NGUITools.DestroyImmediate(go);
        return script;
    }

    /// <summary>
    /// Gets the script asset of the specified type.
    /// </summary>

    static public MonoScript GetClassID<T>() where T : MonoBehaviour { return GetClassID(typeof(T)); }
    ...
    {
        MonoScript script = GetClassID(type);
        SerializedObject ob = new SerializedObject(mb);
        ob.Update();
        ob.FindProperty("m_Script").objectReferenceValue = script;
    ...
    static public SerializedObject ReplaceClass(MonoBehaviour mb, MonoScript script)
    {
        SerializedObject ob = new SerializedObject(mb);
        ob.Update();
        ob.FindProperty("m_Script").objectReferenceValue = script;
    ...
    static public void ReplaceClass(SerializedObject ob, MonoScript script)
    {
        ob.FindProperty("m_Script").objectReferenceValue = script;
        ob.ApplyModifiedProperties();
        ob.Update();
    ...
    {
        ob.FindProperty("m_Script").objectReferenceValue = GetClassID(type);
        ob.ApplyModifiedProperties();
        ob.Update();
    }
    ...
    static public void UpgradeTexturesToSprites(UIAtlas atlas)
    {
        ...
        if (uits.Count > 0)
        {
            ...
            MonoScript spriteID = GetClassID<UISprite>();
